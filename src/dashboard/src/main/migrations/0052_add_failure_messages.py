...
def data_migration(apps, schema_editor):
    ...
    job_fail_messages = (
        ...
        Message(
            ...
            message='At least one checksum provided in the Transfer is not accurate for the file it is meant to describe. This could be due to a problem in the checksum file, or may be because the file itself has been corrupted or modified since the original checksum was created. Check the dashboard for this job to see a list of standard errors for each file that had a checksum that did not pass verification.',
        ),
        Message(
        ...
        Message(
            ...
            message='Check the Dashboard to see which files have errors associated with them. Some errors may be due to limitations of the tools being used. Modifying FPR rules to change which tools run on which formats may reduce the number of errors produced.',
        ),
        Message(
        ...
        Message(
            ...
            message='Check the Dashboard to see which files resulted in errors during extraction. Some errors may be due to limitations of the tools being used. Modifying FPR rules to change which tools run on which formats may reduce the number of errors produced.',
        ),
        Message(
        ...
        Message(
            ...
            message='Email notifications may fail if a working email server is not configured or available. Failure reports can also be found through the dashboard.',
        ),
        Message(
        ...
        Message(
            ...
            message='Failure to move or copy files may be due to lack of disk space. Check Processing Storage Usage in the Administration screen, or contact your administrator.',
        ),
        Message(
        ...
        Message(
            ...
            message='Format identification will fail if any objects can\'t be identified. Consider processing the files again with a different tool.',
        ),
        Message(
